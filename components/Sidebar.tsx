...
const navigation = [
  ...
  { name: 'إدارة الأفكار', href: '/ideas', icon: LightBulbIcon },
  { name: 'إدارة الاجتماعات', href: '/meetings', icon: CalendarIcon },
  { name: 'إدارة المشاريع', href: '/projects', icon: ClipboardDocumentListIcon },
  { name: 'إدارة المهام', href: '/tasks', icon: QueueListIcon },
];
